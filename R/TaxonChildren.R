...
#' offspring and parantage.
#'
#'
#' @aliases TaxonChildren TaxonParents
#' @param MyHiers A vector or single filename for downloaded hierarchy pages
#' @return \code{TaxonChildren} will report the primary offspring of a taxon if
#' the hierarchy page reports this information.  \code{TaxonParents} will

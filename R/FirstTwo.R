...
#' 
#' This function strips a taxon name to the first two words.  Many times, and
#' EOL species name will come in with additional data (such as the describer,
#' subspecies, variety, etc).  This will prune it down to just two names.
#' 
#' 
